...
public class IngresarFutbolista extends JDialog {
	...
	public IngresarFutbolista (String titulo) {
		...
		panelCentral.add(lblApellido);panelCentral.add(tfApellido);
		panelCentral.add(lblEmail);panelCentral.add(tfEmail);
		panelCentral.add(lblTelefono);panelCentral.add(tfTelefono);
		panelCentral.add(lblPais);panelCentral.add(tfPais);
